...
class Config_BUSI:
    ...
    data_path = "/data/zwt/dataset/SAMUS_dataset/BUSI/"
    data_subpath = "/data/zwt/dataset/SAMUS_dataset/BUSI/Breast-BUSI/"
    save_path = "./ckpt/BUSI/msaghfc/non_normal/"
    result_path = "./result_ckpt/BUSI/msaghfc/non_normal/"
    tensorboard_path = "./tensorboard/BUSI/"
    load_path = "/data/zwt/project/SAMUS/checkpoint/sam_vit_b_01ec64.pth"
    save_path_code = "_"

    workers = 1                         # number of data loading workers (default: 8)
    epochs = 400                        # number of total epochs to run (default: 400)
    batch_size = 4                      # batch size (default: 4)
    learning_rate = 5e-4                # initial learning rate (default: 0.001)
    momentum = 0.9                      # momentum
    classes = 2                         # the number of classes (background + foreground)
    img_size = 256                      # the input size of model
    ...
    crop = None                         # the cropped image size
    eval_freq = 1                       # the frequency of evaluate the model
    save_freq = 100                     # the frequency of saving the model
    device = "cuda"                     # training device, cpu or cuda
    cuda = "on"                         # switch on/off cuda option (default: off)
    gray = "yes"                        # the type of input image
    img_channel = 1                     # the channel of input image
...
class Config_UDIAT:
    # This dataset is for breast cancer segmentation
    data_path = "/data/zwt/dataset/SAMUS_dataset/UDIAT/"
    data_subpath = "/data/zwt/dataset/SAMUS_dataset/UDIAT/Breast-UDIAT/"
    save_path = "./ckpt/UDIAT/msaghfc/non_normal/"
    result_path = "./result_ckpt/UDIAT/msaghfc/non_normal/"
